...
// Gameplay constants.
const COLORS = [ '#c0585b', '#587da7', '#587879', '#6a6a6b' ];
const FRONT_COLORS = ['#ad2629', '#26568c', '#264f51', '#3d3d3f' ];
const SIDE_COLORS = ['#9f0004', '#003878', '#003033', '#1b1b1d' ];
const BOTTOM_COLORS = ['#870003', '#003066', '#00292b', '#171719' ];
...
const TEXT_CREDITS = ["Quintacolor v 1.0.2",
