...
The first player places their five pieces on their side of the board, the second player does the same, then it goes as Maizie says: "you move [between zero and] two times [as far as you want along contiguous spaces] and then push one square and you get a red hat and how you win the game is push off the edge." Only the square pieces can push, and the red hat is an anchor that locks that piece in place until your next turn.
