...
where k is the number of faces on the die and n is the target number. This means if that you were aiming for some arbitrarily high target with a d6, your chances of success would be exactly <sup>2</sup>&frasl;<sub>7</sub>. This really surprised me at first. Not <sup>2</sup>&frasl;<sub>6</sub>? Upon extensive reflection, though, this makes sense. The average roll on a d6 is 3.5, which has you stepping down the number line 3.5 units at a time, on average. What's the chance you hit a number exactly? <sup>1</sup>&frasl;<sub>3.5</sub>, or <sup>2</sup>&frasl;<sub>7</sub>.
