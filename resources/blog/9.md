...
That's right: the easiest target to hit is 6, with a roughly 36% chance! 7 is way less likely; at ~25.4% it's harder even than 5 or 4. And here was a surprise to me: 11 is just a little better than 12. Huh. I would have bet money.

<b>TL;DR:</b> if the Robot has the ability to massage the distance between the running total ("CPU") and the target, aim for 6, 5, and 11. Let's round out with a fancy graph that generalizes this problem to dice with more than 6 faces:
