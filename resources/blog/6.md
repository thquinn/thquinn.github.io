...
I didn't know how to code back in the Mirrodin era, but I do now, so why not write a little something to optimize a combo decklist? I'd seen Jan van der Vegt [try to apply machine learning](https://github.com/janvdvegt/belchAIr) to <auto-card>Goblin Charbelcher</auto-card>, and while that's still a little beyond me at the moment, we can still learn a thing or two from regular ol' Monte Carlo. I found a combo that met my needs (simple, janky, unpopular) and got to work.
...
<pre><code>+2 Lost Auramancers
-1 Plains
-3 Swamp
+2 Orzhov Basilica
+2 Pelakka Caverns: 1000000 trials complete. Average win turn: 9.02.</code></pre>
