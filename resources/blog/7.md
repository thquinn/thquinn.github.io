...
We can't expect much depth from our branching factor ~30 search, so I made the choice to start copies of Frantic Inventory at 2. My intuition is that 0 or 4 are local minima too strong to overcome with the amount of compute I have. I also made a few hypotheses:
